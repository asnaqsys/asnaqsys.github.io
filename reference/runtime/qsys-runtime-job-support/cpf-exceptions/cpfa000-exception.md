...
| Name | Description |
| --- | --- |
| [CPFA000Exception](#cpfa000exceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPFA000Exception class.
...
```cs
CPFA000Exception(String, Exception)
```
