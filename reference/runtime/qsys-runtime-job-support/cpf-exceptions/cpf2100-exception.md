---
title: "CPF2100Exception class        | QSYS API Reference Guide"
...
| Name | Description |
| --- | --- |
| [CPF2100Exception](#cpf2100exceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF2100Exception class.
...
```cs
CPF2100Exception(String, Exception)
```
