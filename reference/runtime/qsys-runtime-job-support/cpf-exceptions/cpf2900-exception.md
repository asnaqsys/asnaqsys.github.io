---
title: "CPF2900Exception class        | QSYS API Reference Guide"
...
| Name | Description |
| --- | --- |
| [CPF2900Exception](#cpf2900exceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF2900Exception class.
...
```cs
CPF2900Exception(String, Exception)
```
