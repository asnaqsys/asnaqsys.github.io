...
| Name | Description |
| --- | --- |
| [CPF3068Exception](#cpf3068exceptionstring-string-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF3068Exception class.
...
```cs
CPF3068Exception(String, String, Exception)
```
