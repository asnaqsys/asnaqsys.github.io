---
title: "CPF8A00Exception class        | QSYS API Reference Guide"
...
| Name | Description |
| --- | --- |
| [CPF8A00Exception](#cpf8a00exceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF8A00Exception class.
...
```cs
CPF8A00Exception(String, Exception)
```
