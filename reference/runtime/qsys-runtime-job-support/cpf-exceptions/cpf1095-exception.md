---
title: "CPF1095Exception class        | QSYS API Reference Guide"
...
| Name | Description |
| --- | --- |
| [CPF1095Exception](#cpf1095exceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF1095Exception class.
...
```cs
CPF1095Exception(String, Exception)
```
...
| --- | --- | ---
| [String](https://docs.microsoft.com/en-us/dotnet/api/system.string) | systemValue | The name of the system value.
