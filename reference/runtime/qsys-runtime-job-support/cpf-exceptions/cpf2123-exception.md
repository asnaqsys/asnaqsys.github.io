...
| Name | Description |
| --- | --- |
| [CPF2123Exception](#cpf2123exceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF2123Exception class.
...
```cs
CPF2123Exception(String, Exception)
```
