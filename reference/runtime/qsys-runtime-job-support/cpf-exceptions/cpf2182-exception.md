---
title: "CPF2182Exception class        | QSYS API Reference Guide"
...
| Name | Description |
| --- | --- |
| [CPF2182Exception](#cpf2182exceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF2182Exception class.
...
```cs
CPF2182Exception(String, Exception)
```
