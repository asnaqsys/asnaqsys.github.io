---
title: "CPF2203Exception class        | QSYS API Reference Guide"
...
| Name | Description |
| --- | --- |
| [CPF2203Exception](#cpf2203exceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF2203Exception class.
...
```cs
CPF2203Exception(String, Exception)
```
