...
| Name | Description |
| --- | --- |
| [CPF320BException](#cpf320bexceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF320BException class.
...
```cs
CPF320BException(String, Exception)
```
