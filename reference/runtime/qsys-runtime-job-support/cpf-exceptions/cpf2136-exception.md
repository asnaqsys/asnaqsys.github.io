...
| Name | Description |
| --- | --- |
| [CPF2136Exception](#cpf2136exceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF2136Exception class.
...
```cs
CPF2136Exception(String, Exception)
```
