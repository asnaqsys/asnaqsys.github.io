---
title: "CPF2166Exception class        | QSYS API Reference Guide"
...
| Name | Description |
| --- | --- |
| [CPF2166Exception](#cpf2166exceptionstring-exception)([String](https://docs.microsoft.com/en-us/dotnet/api/system.string), [Exception](https://docs.microsoft.com/en-us/dotnet/api/system.exception)) | Initializes a new instance of the CPF2166Exception class.
...
```cs
CPF2166Exception(String, Exception)
```
