...
*   **SingleRecordProgram**: *SingleRecordProgram* is another specialization of *InteractiveProgram* providing the basis for management of single-record displays or edits with support for multiple screens.
*   **Specific Interaction Patterns**: Concrete subclasses of the above classes derivatives, such as *PromptRecordFunction*, *EditRecordFunction*, *DisplayTransactionFunction* and *EditFileFunction*,  provide tailored workflows. For instance, *PromptRecordFunction* drives prompt-based record interactions, while *DisplayRecordFunction* manages single-record displays with support for multiple screens.
